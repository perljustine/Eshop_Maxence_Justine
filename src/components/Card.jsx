...
function Card({name, quantity, price}) {
                ...
                <div className="mt-4 px-5 pb-5">
                    ...
                    <div className="mt-2 mb-5 flex items-center justify-between">
                        ...
                        <div className="flex items-center">
                            ...
                            <span
                                className="mr-2 ml-3 rounded bg-yellow-200 px-2.5 py-0.5 text-xs font-semibold">{quantity}</span>
                        </div>
                    </div>
                    <a href="#"
                       className="flex items-center justify-center rounded-md bg-slate-900 px-5 py-2.5 text-center text-sm font-medium text-white hover:bg-gray-700 active:outline-none active:ring-4 active:ring-blue-300">
