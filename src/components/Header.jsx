function Header() {
    return (
      <div className="bg-violet-800 py-32">
        <div className="flex flex-col justify-center items-center">
          ...
          <div className="relative text-center mt-5 mb-12 text-5xl font-medium">
            <h1 className="relative text-white pb-3 leading-[65px] z-10 isolate">Les meilleurs Bonbons<br />Venu tout droit des 4 coins du monde !</h1>
