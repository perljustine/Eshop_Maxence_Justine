function Header() {
    return (
      <div className="bg-linear-to-bl from-violet-800 via purple-400 to-fuchsia-500 py-26">
        <div className="flex flex-col justify-center items-center  ">
          <div className="flex items-center justify-center rounded-full outline-dashed outline-white px-4 py-[6px] mb-6">
            <div className="w-5 h-5 rounded-full text-zinc-400  mr-2 ">
